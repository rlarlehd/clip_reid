...
class MSMT17_GallerySwap(BaseImageDataset):
    dataset_dir = 'msmt17_galleryswap'

    def __init__(self, root='', verbose=True, pid_begin=0, **kwargs):
        super(MSMT17_GallerySwap, self).__init__()
        ...
        # gallery만 swap
        query = self._process_dir(self.orig_test_dir, self.list_query_path)
        gallery = self._process_dir(self.swap_test_dir, self.list_gallery_path)

        if verbose:
            print("=> MSMT17 GallerySwap loaded")
